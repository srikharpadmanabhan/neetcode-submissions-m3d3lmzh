...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.mhsa_attn = self.MultiHeadedSelfAttention(model_dim, num_heads)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        attn_output = embedded + self.mhsa_attn(self.norm1(embedded))
        ff_output = attn_output + self.linear(self.norm2(attn_output))
        
        return torch.round(ff_output, decimals=4)
